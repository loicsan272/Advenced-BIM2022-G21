...
function main() {
	...
	console.log($(this)[0].innerHTML);
		$( this ).on("click", function(){
			...
			changePlan($(this).attr('name')+':'+$(this).attr('level'),$(this).attr('struct'));
			//$( this ).innerHTML
		});
	});
...
jQuery('<div>', {
    id: 'plan',
    class: 'plan',
    title: 'click on a floor to see the plan',
	html:text
}).appendTo('plan-');  
	
}

function changePlan(text,se) {
	$('#plan').html(text);
	$('props-').html("<b>Structural Elements contained in this floor:</b><br>"+se)
